...
(function(){
	...
	var defaultConfig = {
		...
		//legendTemplate : "<ul class=\"<%=name.toLowerCase()%>-legend\"><% for (var i=0; i<datasets.length; i++){%><li><span class=\"<%=name.toLowerCase()%>-legend-icon\" style=\"background-color:<%=datasets[i].fillColor%>\"> 123</span><span class=\"<%=name.toLowerCase()%>-legend-text\"><%if(datasets[i].label){%><%=datasets[i].label%><%}%></span></li><%}%></ul>"
...
//					var activeBars = (evt.type !== 'mouseout') ? this.getBarsAtEvent(evt) : [];
			...
			helpers.each(data.datasets,function(dataset,datasetIndex){
              ...
              //  alert("颜色。。"+dataset.fillColor+"值。。"+dataset.data[datasetIndex]);
...
(function(){
	...
	var defaultConfig = {
		...
		bezierCurve : false, //false为折线，ture为曲线
