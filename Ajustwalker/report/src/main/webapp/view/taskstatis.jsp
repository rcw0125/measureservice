	...
	<body class="container-fluid" style="padding-top:15px;">
				...
				<div class="col-sm-3">
					<div class="form-group input-group input-group-sm">
						<span class="input-group-addon" id="sizing-addon3">计量员</span> <input
							type="text" class="form-control" placeholder="计量员" id="opname"
							name="opname" aria-describedby="sizing-addon3">
					</div>
				</div>
		...
		<div class="row" style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
			<div class="col-sm-12">
				<table id="TaskCountGrid" data-toggle="table"
					...
					<thead>
						<tr>
							<th data-field="opname" data-halign="center" sortable>计量员</th>
		...
		<script type="text/javascript">
			...
			$('#TaskCountGrid').bootstrapTable({
				onLoadSuccess : function(data) {getpicture();}
			});
				...
				$("#queryform").ajaxSubmit({
					...
					success : function(data) {
						...
						for (var i = 0; i < data.list.length; i++) {
							labelslist.push(data.list[i].opname);
