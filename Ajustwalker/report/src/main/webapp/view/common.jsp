...
<style type="text/css">
	...
	.bootstrapTableEditable .select2-selection{
		box-shadow: inset 0 0px 0px rgba(0, 0, 0, 0) !important;
		border: 0px solid transparent !important;
	}
	.bootstrapTableEditable .form-control{
		box-shadow: inset 0 0px 0px rgba(0, 0, 0, 0) !important;
		border: 0px solid transparent !important;
	}
</style>
	            ...
	            if(tagName=='INPUT'){
	            	...
	            	if($(this).hasClass('select2-data-ajax')){
	            		if(null != value){
	            			...
	            			$(this).val(null).trigger('change',{term:null,setvalue:true,remote:false});
	            		}
	            	}
	            	else{
	            		$(this).val(value).trigger('change',{term:value,setvalue:true,remote:false});
	            	}
	            }
	        });
	    }
