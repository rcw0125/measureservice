...
<body class="container-fluid" style="padding-top: 15px;">
		...
		<div class="row">
			<div class="col-sm-3">
				<div class="form-group input-group input-group-sm">
					...
					</select> <input type="hidden" id="matchids" name="matchids" value="" /> 
					<input type="hidden" id="operatypes" name="operatypes" value="${param.opeatype}" /> 
					<input type="hidden" id="operatype" name="operatype" value="${param.opeatype}" /> 
					<input type="hidden" id="titlename" name="titlename" value="${param.titlename}" /> 
					<input type="hidden" id="reportname" name="reportname" value="<%=yearm%>" /> 
	...
	<div class="row">
		<div class="col-sm-12">
			<table id="tMeasureDetailGrid" data-toggle="table" data-query-params="queryParams" data-row-style="rowStyle" data-pagination="true" data-show-footer="true" data-page-size="20" data-page-list="[20, 40, 80, ALL]" data-side-pagination="server" data-sort-name="suttletime" data-sort-order="desc">
				<thead>
					<tr>
	...
	<script type="text/javascript">
		...
		function queryinfo() {
			$('#tMeasureDetailGrid').bootstrapTable('refresh', {
		...
		function exportExcel() {
			remoteExportExcel('tMeasureDetailGrid', '', '火运计量明细',
					'queryform');
		}
		...
		function print(spec) {
			var url_v = '';
			if (0 == spec) {
				url_v = '<c:url value="/measurereport/printtMeasureDetailZZ.do"/>';
			}
			startwaiting();
			var gridData = $('#tMeasureDetailGrid').bootstrapTable(
					'getSelections');
