        ...
        $.each(this.columns, function (i, column) {
            ...
            column.formatter = function (value, row, index) {
                ...
                if('combobox'== column.edittype){
                	...
                	return ['<form id="' + that.$el[0].id + column.field + index + 'form"><div class="input-group input-group-sm" style="width:100%;">',
                	...
                	return ['<form id="' + that.$el[0].id + column.field + index + 'form"><div class="input-group input-group-sm date" style="width:100%;">',
