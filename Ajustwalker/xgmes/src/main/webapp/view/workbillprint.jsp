		...
		<div id="printtable" style="width:100%;padding:0px;margin:0px;">
			<c:forEach items="${printheaddata}" var="head" varStatus="num1">
				<div style="page-break-after:always;adding:0px;margin:0px;">
					<table id="innerprinttable${num1.index}" style="width:100%;padding:0px;margin:0px;">
						<tr>
							<td colspan="3" style="text-align:center;">
								<h1 style="margin-top:10px;">作业单</h1>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="3">
								<table class="detailtable" style="width:100%;padding:0px;margin:0px;" border="1">
									...
									<c:forEach items="${printbodydata}" var="body" varStatus="num2">
										<c:if test="${(head.carno == body.carno && (null != body.materialcode && fn:startsWith(body.materialcode,head.prematerialcode))) || (head.carno == body.carno && null == body.materialcode)}">
											<tr>
												...
												<td valign="top">${body.plancounts}</td>
												<td valign="top"></td>
