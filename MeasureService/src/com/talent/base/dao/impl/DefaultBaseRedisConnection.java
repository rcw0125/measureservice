 ...
 */
public class DefaultBaseRedisConnection implements StringRedisConnection {

	private static final byte[][] EMPTY_2D_BYTE_ARRAY = new byte[0][];

	private final Log log = LogFactory.getLog(DefaultBaseRedisConnection.class);
	...
	private class DeserializingConverter implements Converter<byte[], String> {
		public String convert(byte[] source) {
			Object o = serializer.deserialize(source);
	...
	private class TupleConverter implements Converter<Tuple, StringTuple> {
		public StringTuple convert(Tuple source) {
			return new DefaultStringTuple(source, serializer.deserialize(source.getValue()).toString());
		}
	}
	...
	/**
	 * Constructs a new <code>DefaultBaseRedisConnection</code> instance. Uses
	 * {@link StringRedisSerializer} as underlying serializer.
	 * 
	 * @param connection
	 *            Redis connection
	 */
	public DefaultBaseRedisConnection(RedisConnection connection) {
		Assert.notNull(connection, "connection is required");
		this.delegate = connection;
		this.serializer = new BaseRedisSerializer();
	}

	/**
	 * Constructs a new <code>DefaultBaseRedisConnection</code> instance.
	 * 
	 * @param connection
	 *            Redis connection
	 * @param serializer
	 *            String serializer
	 */
	public DefaultBaseRedisConnection(RedisConnection connection, RedisSerializer<Object> serializer) {
		Assert.notNull(connection, "connection is required");
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisStringCommands#pSetEx(byte
	 * [], long, byte[])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisServerCommands#shutdown(
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisZSetCommands#zCount(byte[]
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisZSetCommands#zRangeByScore
	 * (byte[],
	 * org.springframework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	 ...
	 * 
	 * @see org.springframework.data.redis.connection.RedisZSetCommands#
	 * zRevRangeByScoreWithScores(byte[],
	 * org.springframework.data.redis.connection.RedisZSetCommands.Range)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.StringRedisConnection#pSetEx(
	...
	/**
	 * NOTE: This method will not deserialize Strings returned by Lua scripts,
	 * as they may not be encoded with the same serializer used here. They will
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisServerCommands#slaveOf(
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.springframework.data.redis.connection.RedisServerCommands#
	 * slaveOfNoOne()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.springframework.data.redis.connection.RedisKeyCommands#scan(org.
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisSetCommands#scan(byte[],
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisHashCommands#hscan(byte[],
	 * org.springframework.data.redis.core.ScanOptions)
	 */
	@Override
	 ...
	 * If false, results of {@link #closePipeline()} and {@link #exec()} will be
	 * of the type returned by the underlying connection
	 * 
	...
	private List<Object> convertResults(List<Object> results, Queue<Converter> converters) {
		...
		if (results.size() != converters.size()) {
			// Some of the commands were done directly on the delegate, don't
			// attempt to convert
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.springframework.data.redis.connection.StringRedisConnection#
	 * setClientName(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisServerCommands#killClient(
	 * byte[])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.StringRedisConnection#hScan(
	 * java.lang.String, org.springframework.data.redis.core.ScanOptions)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.StringRedisConnection#sScan(
	 * java.lang.String, org.springframework.data.redis.core.ScanOptions)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.StringRedisConnection#zScan(
	 * java.lang.String, org.springframework.data.redis.core.ScanOptions)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.HyperLogLogCommands#pfAdd(byte[
	 * ], byte[][])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.StringRedisConnection#pfAdd(
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.HyperLogLogCommands#pfCount(
	 * byte[][])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.StringRedisConnection#pfCount(
	 * java.lang.String[])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.HyperLogLogCommands#pfMerge(
	 * byte[], byte[][])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.StringRedisConnection#pfMerge(
	 * java.lang.String, java.lang.String[][])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.springframework.data.redis.connection.RedisZSetCommands#zRangeByLex(
	 * byte[])
	 */
	@Override
